...
from bugcode_plugins.plugins.plugins_utils import its_cve, its_cwe

logger = logging.getLogger("bugcode").getChild(__name__)
...
class PluginBase:
    ...
    def processReport(self, filepath: Path, user="bugcode"):
