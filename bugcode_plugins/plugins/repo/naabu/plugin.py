"""
Bugcode Plugins
Copyright (c) 2021 Bugcode Security LLC (https://www.threatcode.github.io/bugcode/)
...
import json
import re
from bugcode_plugins.plugins.plugin import PluginMultiLineJsonFormat

__author__ = 'Emilio Couto'
__copyright__ = 'Copyright (c) 2021, Bugcode Security LLC'
__credits__ = ['Emilio Couto']
__license__ = ''
__version__ = '0.0.1'
__maintainer__ = 'Emilio Couto'
__email__ = 'ecouto@threatcode.github.io/bugcode'
