...
from bugcode_plugins.plugins.repo.nessus.plugin import NessusPlugin

from bugcode_agent_dispatcher.utils.url_utils import resolve_hostname
...
def main():
    ...
    TENABLE_SCAN_NAME = os.getenv("EXECUTOR_CONFIG_TENABLE_SCAN_NAME", "bugcode-scan")
