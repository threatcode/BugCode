...
import urllib3
from bugcode_plugins.plugins.repo.qualysguard.plugin import QualysguardPlugin

urllib3.disable_warnings(urllib3.exceptions.InsecureRequestWarning)

BASE_URL = "https://qualysguard.qg4.apps.qualys.com"

HEADERS = {"X-Requested-With": "Bugcode-executor"}
...
def launch_scan(ip, option_profile, auth):
    url = BASE_URL + f"/api/2.0/fo/scan/?action=launch&scan_title=Bugcode-Scan&ip={ip}"
