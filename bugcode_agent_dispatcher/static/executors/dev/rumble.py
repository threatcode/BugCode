...
def convert_rumble_assets(assets: list):
    ...
    bugcode_assets = dict(hosts=hosts)

    return bugcode_assets
...
async def main():
    ...
    bugcode_assets = convert_rumble_assets(assets)

    print(json.dumps(bugcode_assets))
